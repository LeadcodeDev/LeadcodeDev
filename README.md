...
![icons technologies](https://skillicons.dev/icons?i=rust,ts,dart)
 
## 🏗️ Architecture & software craftsmanship
...
![icons technologies](https://skillicons.dev/icons?i=scss,tailwind,nodejs,adonis,vite,vue,react,nuxt,next,astro,flutter,rabbitmq,redis,docker,kubernetes,git,postgres,idea,webstorm,postman&perline=10)
